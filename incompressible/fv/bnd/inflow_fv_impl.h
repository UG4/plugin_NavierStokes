...
#ifndef __H__UG__NAVIER_STOKES__BND__INFLOW_FV_IMPL__
#define __H__UG__NAVIER_STOKES__BND__INFLOW_FV_IMPL__
...
NavierStokesInflowFV<TDomain,TAlgebra>::
NavierStokesInflowFV(SmartPtr< NavierStokesFV<TDomain> > spMaster)
	: m_spNeumannDisc(new NeumannBoundaryFV<TDomain>(spMaster->symb_fcts()[dim].c_str())),
...
template <typename TDomain, typename TAlgebra>
void NavierStokesInflowFV<TDomain,TAlgebra>::
...
#endif /* __H__UG__NAVIER_STOKES__BND__INFLOW_FV_IMPL__ */
