...
#ifndef __H__UG__NAVIER_STOKES__INCOMPRESSIBLE__BND__INFLOW_BASE__
#define __H__UG__NAVIER_STOKES__INCOMPRESSIBLE__BND__INFLOW_BASE__
...
#endif /* __H__UG__NAVIER_STOKES__INCOMPRESSIBLE__BND__INFLOW_BASE__ */
