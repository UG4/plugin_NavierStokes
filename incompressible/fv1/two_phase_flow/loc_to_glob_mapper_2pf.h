...
#ifndef MAPPER_2PF_H_
#define MAPPER_2PF_H_

#include "lib_disc/spatial_disc/immersed_util/interface_handler/interface_handler_base.h"
...
class InterfaceMapper2PF : public IInterfaceMapper<TAlgebra>
{
...
#include "loc_to_glob_mapper_2pf_impl.h"
