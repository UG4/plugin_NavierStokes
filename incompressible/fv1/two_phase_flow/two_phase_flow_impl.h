...
#ifndef PF2_INTERFACE_IMPL_
#define PF2_INTERFACE_IMPL_
...
MovingInterface2PF<TDomain, TAlgebra>::MovingInterface2PF(
    ...
    m_spInterfaceMapper(new InterfaceMapper2PF<TDomain, TAlgebra> (m_spInterfaceHandlerLocal))
{
...
template<typename TDomain, typename TAlgebra>
double MovingInterface2PF<TDomain, TAlgebra>::
...
template<typename TDomain, typename TAlgebra>
void MovingInterface2PF<TDomain, TAlgebra>::
...
template<typename TDomain, typename TAlgebra>
const size_t MovingInterface2PF<TDomain, TAlgebra>::
...
template<typename TDomain, typename TAlgebra>
number MovingInterface2PF<TDomain, TAlgebra>::
