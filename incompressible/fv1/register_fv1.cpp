...
void Init___NavierStokes___FV1_(TRegistry* reg, string grp)
{
...
void Init___NavierStokes___FV1(Registry* reg, std::string grp)
{ Init___NavierStokes___FV1_<Registry>(reg, grp); }

#ifdef UG_USE_PYBIND11
void Init___NavierStokes___FV1(ug::pybind::Registry* reg, std::string grp)
{ Init___NavierStokes___FV1_<ug::pybind::Registry>(reg, grp); }
#endif
